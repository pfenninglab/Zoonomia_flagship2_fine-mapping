...
#####################################################################
## 4) add the base column calculate the M file from the annot parquet
LABEL=Zoonomia_phyloP_phast_HAR
for CHR in {1..22}; do 
...
sbatch --partition=pfen3 --time 23:00:00 --job-name=${LABEL} --mem=45G --array=1-22 --time 1-0:00:00 \
...
rm ${ANNOTDIR}/ext500.* ${ANNOTDIR}/241m.* ${ANNOTDIR}/*extend500* \
${ANNOTDIR}/Zoonomia_phyloP_extend500*  ${ANNOTDIR}/Zoonomia_phast_HAR_extend500*
