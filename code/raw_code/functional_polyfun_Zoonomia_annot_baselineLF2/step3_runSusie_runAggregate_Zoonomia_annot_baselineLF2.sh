...
# 23G good for blocks w/ -lt 15k SNPs, 47G good for blocks <30k snps
...
sbatch -p pool1,pfen1 --mem 45G --dependency=afterok:1608628 --time 3-0:00:00 --array 1-22 \
...
OUTDIR=${DATADIR}/${PREFIX}/susie
if [[ ! -f ${DATADIR}/${PREFIX}/${PREFIX}_Zoonomia_annot_baselineLF2_top_annot.txt.gz && -f ${OUTDIR}/polyfun_all_jobs_22.txt ]]; then
