...
sbatch -p pool1 --mem 46G --time 24:00:00 --array 1-22 \
...
sbatch -p short1 --mem 62G --time 2:00:00 --export=JobsFileName=${JobsFileName} ${CODEDIR}/slurm_finemap_byLine.sh
done
...
--partition short1 --time 2:00:00 --mem 30G ${CODEDIR}/slurm_polyfun_aggregate.sh
done
